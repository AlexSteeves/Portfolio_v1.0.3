...
export default function NavLinks() {
  ...
  return (
    <div > 
      ...
      <h1 className="flex justify-center items-center pt-2 text-xl underline underline-offset-2 font-thin"><link href={process.env.PUBLIC_URL + 'pictures/Steeves_Resume_V1.0.3.pdf'}>Resume</link></h1>
    </div >
  );
}
